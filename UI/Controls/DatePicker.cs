...
{
    /// <summary>
    /// Represents an Android implementation of an <see cref="INativeDatePicker"/>.
    /// </summary>
    [Preserve(AllMembers = true)]
    [Register(typeof(INativeDatePicker))]
    public class DatePicker : global::Android.Widget.Button, INativeDatePicker
    {
        /// <summary>
            ...
            : base(Application.MainActivity)
        {
            ...
            pickerDialog.ShowEvent += (sender, e) => OnPropertyChanged(Prism.UI.Controls.DatePicker.IsOpenProperty);
            pickerDialog.DismissEvent += (sender, e) => OnPropertyChanged(Prism.UI.Controls.DatePicker.IsOpenProperty);
        }
        ...
        private void SetTitle()
        {
            if (selectedDate.HasValue)
            {
                Text = selectedDate.Value.ToString(dateStringFormat ?? "d");
            }
            else
            {
