    ...
    public class PolyShapeBase : global::Android.Views.View, INativePolyShape
    {
        ...
        public FillRule FillRule
        {
            get
            {
                ...
                return fillType == Path.FillType.EvenOdd || fillType == Path.FillType.InverseEvenOdd ? FillRule.EvenOdd : FillRule.Nonzero;
            }
            set
            {
                var fillType = value == FillRule.EvenOdd ? Path.FillType.EvenOdd : Path.FillType.Winding;
