...
namespace Prism.Android.UI.Shapes
{
    ...
    public class Quadrangle : global::Android.Views.View, INativeQuadrangle
    {
        ...
        protected override void OnDraw(global::Android.Graphics.Canvas canvas)
        {
            ...
            if (fill != null)
            {
                canvas.DrawRoundRect(rect, (float)(radiusX * Device.Current.DisplayScale),
                    (float)(radiusY * Device.Current.DisplayScale), FillPaint);
            }

            canvas.DrawRoundRect(rect, (float)(radiusX * Device.Current.DisplayScale),
                (float)(radiusY * Device.Current.DisplayScale), StrokePaint);
        }
